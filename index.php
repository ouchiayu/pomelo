	...
	<div>
		<header id="header" class="">
			...
			<div class="owl-carousel">
				<div>花蓮鶴岡老欉紅柚 <br>一箱 20 斤，含運費，$ 1,000<br>限量 300 箱！暫定 10/28 採收</div>
				<div>搶先預購的每箱都有抽中免費一箱紅柚的機會喔！</div>
				<div>使用匯款或現金付款方式的人記得在訂單查詢那填寫付款資訊</div>
				<div>今年紅柚產量較少，預估只有 300 箱<br>若到時不足 400，將依預購順序優先出貨</div>
				<div>
					紅柚的問題歡迎來電，0928102291<br>
					訂單如有任何問題可來電，0928806748
				</div>
			</div>
		</header><!-- /header -->
